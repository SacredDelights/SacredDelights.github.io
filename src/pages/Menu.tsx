import menu from "../images/menu-mr.webp";
export default function Menu() {
  return (
    <div className="relative h-64 w-full bg-cover bg-bottom justify-center bg-[url('https://raw.githubusercontent.com/SacredDelights/SacredDelights.github.io/refs/heads/main/src/gallery/54FCEEB5-472A-43B6-94FA-C9E19FA6A23B.webp')] flex flex col h-auto bg-fixed">
