          ...
          <div className="contact-wrap">
            <div className={"flex items-center mb-8"}>
              ...
              <div className={"flex pl-4"}>
                <p className={"flex flex-col contact-link"}>
                  <strong>
                    <span>Pick-up location: </span>
                  </strong>
                  <a href="https://maps.app.goo.gl/xnSUMdMaegPAZNfo7">
                    Pier 8, 33556
                  </a>
                </p>
              </div>
            ...
            <div className={"flex items-center mb-8"}>
              ...
              <div className={"flex pl-4"}>
                <p className={"flex flex-col contact-link"}>
                  ...
                  <a href="tel:+13053605585">+1 (305)360-5585</a>
                </p>
              </div>
            </div>
            <div className={"flex items-center  mb-8"}>
              ...
              <div className={"flex pl-4"}>
                <p className={"flex flex-col contact-link"}>
                  ...
                  <a href="mailto:info@sacreddelights.net">
                    info@sacreddelights.net
                  </a>
                </p>
              </div>
            </div>
